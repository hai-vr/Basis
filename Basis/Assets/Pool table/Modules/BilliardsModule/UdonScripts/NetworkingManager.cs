...
public class NetworkingManager : BasisNetworkBehaviour
{
    ...
    {
        SendCustomNetworkEvent(Pack(0,SyncState.ToBytes()), LiteNetLib.DeliveryMethod.ReliableOrdered);
    }
    ...
    {
        SendCustomNetworkEvent(new byte[] { 1 }, LiteNetLib.DeliveryMethod.ReliableOrdered);
    }
