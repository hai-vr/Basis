...
public class SMModuleCalibration : BasisSettingsBase
{
    ...
    public override void ValidSettingsChange(string matchedSettingName, string optionValue)
    {
        ...
        switch (key)
        {
            case var s when s == K_IK_MODE.ToLowerInvariant():
                {
                    var old = HeightMode;
            ...
            case var s when s == K_SELECTED_HEIGHT.ToLowerInvariant():
                // (Your original code intentionally did nothing here)
                break;

            case var s when s == K_CUSTOM_SCALE.ToLowerInvariant():
                {
            ...
            case var s when s == K_SELECTED_SCALE.ToLowerInvariant():
                {
            ...
            case var s when s == K_REALWORLD_EYE_HEIGHT.ToLowerInvariant():
                {
