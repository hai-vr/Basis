...
/// <summary>
/// Orchestrates pickup-sync networking for owned and remotely owned pickups:
/// sends local updates on a cadence and smoothly lerps remote transforms via a Burst job.
/// </summary>
public static class BasisPickupSyncDriver
{
    public static readonly HashSet<BasisPickupSyncNetworking> OwnedPickupSyncs = new();
    public static readonly HashSet<BasisPickupSyncNetworking> RemoteOwnedPickupSyncs = new();
    ...
    public static void TransmitOwnedPickups(double currentTime)
    {
        ...
        foreach (BasisPickupSyncNetworking obj in OwnedPickupSyncs)
        {
            if (obj != null)
            {
                obj.SendNetworkSync();
    ...
    public static void ScheduleRemoteLerp(float deltaTime)
    {
        ...
        int upperBound = RemoteOwnedPickupSyncs.Count;
        ...
        unsafe
        {
            ...
            foreach (var obj in RemoteOwnedPickupSyncs)
            {
    ...
    #region Static API
    public static void AddLocalOwner(BasisPickupSyncNetworking obj)
    {
        if (obj != null) OwnedPickupSyncs.Add(obj);
    }

    public static void RemoveLocalOwner(BasisPickupSyncNetworking obj)
    {
        if (obj != null) OwnedPickupSyncs.Remove(obj);
    }

    public static void AddRemoteOwner(BasisPickupSyncNetworking obj)
    {
        if (obj != null) RemoteOwnedPickupSyncs.Add(obj);
    }

    public static void RemoveRemoteOwner(BasisPickupSyncNetworking obj)
    {
        if (obj != null) RemoteOwnedPickupSyncs.Remove(obj);
    }
    #endregion
}
