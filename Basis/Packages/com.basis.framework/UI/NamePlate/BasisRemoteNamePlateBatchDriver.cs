...
namespace Basis.Scripts.UI.NamePlate
{
    public static class BasisRemoteNamePlateBatchDriver
    {
        ...
        static NativeList<float4> _hipsData;            // data index -> hips
        ...
        public static void Initialize(int initialNameplates = 128, int initialDataRows = 128, Allocator allocator = Allocator.Persistent)
        {
            ...
            _hipsData = new NativeList<float4>(initialDataRows, allocator);
        ...
        public struct MappedNameplateApplyJob : IJobParallelForTransform
        {
            ...
            [ReadOnly] public NativeArray<float4> outHipsPosData;          // batch-owned data arrays
            ...
            public void Execute(int jobIndex, TransformAccess tx)
            {
                ...
                float4 hips = outHipsPosData[dataIdx];
                float diff = hips.w;
        ...
        public static int AllocateDataRow(float4 hips)
        {
        ...
        public static void UpdateDataRow(int dataIdx, in float4 hips)
        {
            _hipsData[dataIdx] = hips;
        }
        ...
        public static void BulkSetDataRows(NativeArray<float4> hips)
        {
