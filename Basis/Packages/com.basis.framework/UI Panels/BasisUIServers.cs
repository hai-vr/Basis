...
{
    public class BasisUIServers : BasisUIBase
    {
        public static string ServerPanel = "BasisUIServers";
        public BasisUIMovementDriver BasisUIMovementDriver;
        public static BasisUIServers Instance;
        ...
        public void ApplySize()
        {
            ...
            {
                this.transform.localScale = InitalScale * BasisHeightDriver.SelectedAvatarToAvatarDefaultScale;
            }
        }
