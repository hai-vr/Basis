...
namespace Basis.Scripts.Networking.Sync.EditorTools
{
    ...
    /// </summary>
    public class BasisSyncLatencyWindow : EditorWindow
    {
        ...
        [MenuItem("Basis/Debug/Sync Latency")]
        public static void ShowWindow()
        {
            BasisSyncLatencyWindow window = GetWindow<BasisSyncLatencyWindow>();
            window.titleContent = new GUIContent("Sync Latency");
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("Generic Value Sync - End-to-End Latency", EditorStyles.boldLabel);
            ...
            EditorGUILayout.LabelField("Sweeps", EditorStyles.boldLabel);
            ...
            using (new EditorGUI.DisabledScope(EditorApplication.isCompiling))
                if (GUILayout.Button("Run Latency Sweep", GUILayout.Height(30)))
        ...
        void DrawResults()
        {
            ...
            EditorGUILayout.Space(6);
            EditorGUILayout.LabelField("Results (ms)", EditorStyles.boldLabel);
