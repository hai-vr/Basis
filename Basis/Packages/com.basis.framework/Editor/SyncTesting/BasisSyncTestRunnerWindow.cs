...
namespace Basis.Scripts.Networking.Sync.EditorTools
{
    ...
    /// </summary>
    public class BasisSyncTestRunnerWindow : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            window.titleContent = new GUIContent("Sync Test Matrix");
        ...
        void DrawRun()
        {
            ...
            {
                if (GUILayout.Button("Run Matrix", GUILayout.Height(30)))
                    RunMatrix();
            }
