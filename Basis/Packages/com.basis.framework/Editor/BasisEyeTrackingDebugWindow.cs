...
namespace Basis.Scripts.Device_Management.EyeTracking.Editor
{
    ...
    /// </summary>
    public class BasisEyeTrackingDebugWindow : EditorWindow
    {
        ...
        public static void ShowWindow()
        {
            ...
            window.titleContent = new GUIContent("Eye Tracking");
        ...
        private void OnGUI()
        {
            ...
            {
                EditorGUILayout.HelpBox("Enter Play Mode to see live eye-tracking data.", MessageType.Info);
                return;
            }
        ...
        private void DrawIncoming(List<string> blockers)
        {
            ...
            {
                EditorGUILayout.LabelField("No providers registered.", EditorStyles.miniLabel);
        ...
        private void DrawArbitration()
        {
            ...
            {
                EditorGUILayout.LabelField("OSC has gaze but HMD is preferred — OSC direction suppressed.", EditorStyles.miniLabel);
            }
            if (a.GazeFromOsc && a.HmdHasGaze)
            {
                EditorGUILayout.LabelField("HMD has gaze but OSC is preferred — HMD direction suppressed.", EditorStyles.miniLabel);
            }
        ...
        private void DrawConsumers(List<string> blockers)
        {
            ...
            if (!hasEyeGaze)
            {
                EditorGUILayout.LabelField("VRS foveal center falls back to screen center.", EditorStyles.miniLabel);
            }
        ...
        private void DrawBlockers(List<string> blockers)
        {
            ...
            {
                EditorGUILayout.HelpBox(blockers[i], MessageType.Warning);
            }
        }
