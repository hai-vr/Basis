...
namespace Basis.ImagePickup
{
    ...
    /// </summary>
    internal sealed class ZZHeadBasisAnimatedImageGpuCanvas : IDisposable
    {
        ...
        private ZZHeadBasisAnimationFrameAtlas _frameAtlas;
        ...
        public ZZHeadBasisAnimatedImageGpuCanvas(BasisAnimatedImageData data, Material compositorMaterial)
        {
            ...
            ZZHeadBasisAnimationFrameAtlas frameAtlas = null;
            try
            {
                ...
                frameAtlas = new ZZHeadBasisAnimationFrameAtlas(data);
        ...
        {
            ZZHeadBasisAnimationFrameAtlas replacement = null;
            try
            {
                replacement = new ZZHeadBasisAnimationFrameAtlas(_data);
                _frameAtlas?.Dispose();
        ...
        public void EstimateWork(long targetPlayIndex, int targetFrameIndex, out int transitions, out long pixels)
        {
            ...
            ZZHeadBasisAnimatedImageWorkEstimator.Estimate(
                _data,
                _stateValid,
                _currentPlayIndex,
                _currentFrameIndex,
        ...
        )
        {
            ...
            long requiredPixels =
                reset ? ZZHeadBasisAnimatedImageWorkEstimator.ResetPixelCost(_data) : 0;
            ...
            )
            {
                ...
                long transitionPixels = ZZHeadBasisAnimatedImageWorkEstimator.TransitionPixelCost(
                    _data,
                    partialTargetFrame,
                    nextFrameIndex
                );
        ...
        private void AppendFrame(CommandBuffer commands, int frameIndex, BasisAnimatedImageFrame frame)
        {
            ...
            ZZHeadBasisAnimationFrameAtlasLocation location = _frameAtlas.GetLocation(frameIndex);
        ...
        {
            if (_disposed)
                throw new ObjectDisposedException(nameof(ZZHeadBasisAnimatedImageGpuCanvas));
        }
