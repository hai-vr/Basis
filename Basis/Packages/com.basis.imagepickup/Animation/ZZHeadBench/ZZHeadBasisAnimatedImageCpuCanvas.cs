...
{
    internal static class ZZHeadBasisAnimatedImageWorkEstimator
    {
    ...
    /// </summary>
    internal sealed class ZZHeadBasisAnimatedImageCpuCanvas : IDisposable
    {
        ...
        public ZZHeadBasisAnimatedImageCpuCanvas(BasisAnimatedImageData data)
        {
        ...
        )
        {
            ...
            long canvasPixels = ZZHeadBasisAnimatedImageWorkEstimator.ResetPixelCost(_data);
            ...
            _composeHandle = new ZZHeadBasisAnimatedImageCpuComposeJob
            {
        ...
        {
            if (_disposed)
                throw new ObjectDisposedException(nameof(ZZHeadBasisAnimatedImageCpuCanvas));
        }
