...
- Addresses and values can now be networked directly:
  ...
  - HVRAvatarComms now holds a reference to a data store which can be subscribed to (instead of AcquisitionService).
  - AcquisitionService now delegates to a data store
