...
{
    internal static class HVRVixxyLocalizationPhrase
    {
        internal const string ActiveLabel = "Active";
        internal const string AddChoiceLabel = "Add choice";
        ...
        internal const string AffectTheseObjectsLabel = "Affect these objects";
        ...
        internal const string MsgNetworkingUsesHighFrequency = "The option UpdatedExtremelyFrequently should only be used if you are using special external software to update this value all the time, multiple times per second, for example using a face tracking device.\nIt should almost never be used in other circumstances.";
        ...
        internal const string RemoveChoiceLabel = "Remove choice";
        ...
        public const string ValueSmoothingLabel = "Value smoothing";
    }
}
