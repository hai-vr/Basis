...
namespace HVR.Basis.Comms
{
    public class HVRVariableNetworking : MonoBehaviour, IFeatureReceiver
    {
        ...
        private void Awake() => _behaviour = isWearer ? new HVRVariableNetworkingPacket_Wearer(this) : new HVRVariableNetworkingPacket_Remote(this);
        ...
        private class HVRVariableNetworkingPacket_Wearer : IHVRVariableBehaviour
        {
            ...
            public HVRVariableNetworkingPacket_Wearer(HVRVariableNetworking state)
            {
                _state = state;
        ...
        private class HVRVariableNetworkingPacket_Remote : IHVRVariableBehaviour
        {
            private readonly HVRVariableNetworking _state;
            private readonly Dictionary<int, HVRVariableHolder> _addressIdToHolder = new();
            private readonly Dictionary<ushort, int> _networkIdToAddressId = new();

            public HVRVariableNetworkingPacket_Remote(HVRVariableNetworking state)
            {
                _state = state;
            }
