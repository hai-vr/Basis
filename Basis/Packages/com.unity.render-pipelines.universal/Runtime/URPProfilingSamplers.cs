...
namespace UnityEngine.Rendering.Universal
{
    ...
    /// </summary>
    // BASISVR MODIFIED - public so com.basis.framework's performance bar can read these samplers
    // directly. URP 17.6 replaced the URPProfileId enum - which this fork used to make public for
    // exactly that reason - with these static fields, and ProfilingSampler.Get(URPProfileId.X) no
    // longer resolves to the sampler the passes actually record into.
    public static class URPProfilingSamplers
    {
        // CPU
