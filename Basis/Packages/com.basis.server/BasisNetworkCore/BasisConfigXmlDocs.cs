...
namespace Basis.Network.Core
{
    ...
    public static class BasisConfigXmlDocs
    {
        ...
        private static void RegisterServerConfig()
        {
            ...
            t.Fields.Add(new FieldDoc("ImagePickupRangeMeters", " Maximum distance in metres between an image pickup and a player for that player to receive the image. Players entering range later receive an owner-driven catch-up transfer. 0 disables range filtering and lets the server image cache replay to late joiners. float (metres); default 64. "));
