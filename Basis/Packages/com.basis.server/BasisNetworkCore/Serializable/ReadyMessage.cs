...
public static partial class SerializableBasis
{
    public struct ReadyMessage
    {
        ...
        public void Serialize(NetDataWriter Writer)
        {
            ...
            localAvatarSyncMessage.SerializeForChannel(Writer, (Basis.Network.Core.Compression.BasisAvatarBitPacking.BitQuality)localAvatarSyncMessage.DataQualityLevel);
        }
