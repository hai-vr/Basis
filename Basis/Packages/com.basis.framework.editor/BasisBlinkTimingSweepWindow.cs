...
{
    // Basis ▸ Debug ▸ IK ▸ Blink Timing Sweep.
    public class BasisBlinkTimingSweepWindow : EditorWindow
    {
        ...
        [MenuItem("Basis/Debug/IK/Blink Timing Sweep")]
        public static void ShowWindow()
        {
            var w = GetWindow<BasisBlinkTimingSweepWindow>("Blink Timing Sweep");
