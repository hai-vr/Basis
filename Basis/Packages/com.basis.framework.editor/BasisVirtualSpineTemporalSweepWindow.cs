...
{
    // Basis ▸ Debug ▸ IK ▸ Virtual Spine Temporal Sweep.
    public class BasisVirtualSpineTemporalSweepWindow : EditorWindow
    {
        ...
        [MenuItem("Basis/Debug/IK/Virtual Spine Temporal Sweep")]
        public static void ShowWindow()
        {
            var w = GetWindow<BasisVirtualSpineTemporalSweepWindow>("Virtual Spine Temporal Sweep");
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("Drive", EditorStyles.boldLabel);
            ...
            EditorGUILayout.LabelField("Solver Tunables", EditorStyles.boldLabel);
