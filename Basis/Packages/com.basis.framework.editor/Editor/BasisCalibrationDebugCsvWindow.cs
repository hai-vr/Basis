...
/// </summary>
public class BasisCalibrationDebugCsvWindow : EditorWindow
{
    ...
    [MenuItem("Basis/Calibration/Calibration Debug CSV")]
    public static void Open()
    {
        var w = GetWindow<BasisCalibrationDebugCsvWindow>("Calibration Debug CSV");
    ...
    private void DrawFilePicker()
    {
        using (new EditorGUILayout.HorizontalScope())
        {
            ...
            if (_files.Count == 0)
            {
                EditorGUILayout.LabelField("(no CSV files found)", EditorStyles.miniLabel);
                return;
            }
    ...
    private void DrawQuickRead()
    {
        ...
        {
            EditorGUILayout.LabelField("Quick read — head offset frame", EditorStyles.boldLabel);
    ...
    private void DrawTable()
    {
        ...
        EditorGUILayout.LabelField($"{shown} / {_rows.Count} rows shown", EditorStyles.miniLabel);
    }
