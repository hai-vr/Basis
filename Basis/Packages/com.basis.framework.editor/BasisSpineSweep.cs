            ...
            try
            {
                ...
                using (var w = new StreamWriter(path, false, Encoding.UTF8))
                {
                    ...
                    for (int i = 0; i < cases; i++)
                    {
                        ...
                        BasisLocalVirtualSpineDriver.ComputeHipsPosition(neck, up, lenTotal, headYaw, biasScale, desiredXZ, false, tposeHips, out float3 hipsOut);
                        ...
                        BasisLocalVirtualSpineDriver.ComputeHipsPosition(neck, up, lenTotal, headYaw, biasScale, desiredXZ, true, tposeHips, out float3 hipsFreeze);
