...
{
    // Basis ▸ Debug ▸ IK ▸ Eye Gaze Sweep.
    public class BasisEyeSweepWindow : EditorWindow
    {
        ...
        [MenuItem("Basis/Debug/IK/Eye Gaze Sweep")]
        public static void ShowWindow()
        {
            var w = GetWindow<BasisEyeSweepWindow>("Eye Gaze Sweep");
