...
[CustomEditor(typeof(BasisMediaPlayerMultiChannelAudio))]
public class BasisMediaPlayerMultiChannelAudioInspector : Editor
{
    private const string UxmlPath = "Packages/com.basis.mediaplayer/Editor/StyleSheets/MediaPlayerMultiChannelSDK.uxml";
    ...
    public override VisualElement CreateInspectorGUI()
    {
        ...
        if (tree == null)
        {
            _root.Add(new HelpBox("MediaPlayerMultiChannelSDK.uxml missing.", HelpBoxMessageType.Error));
            return _root;
        }
