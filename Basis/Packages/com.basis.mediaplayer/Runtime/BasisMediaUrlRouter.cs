...
public static class BasisMediaUrlRouter
{
    ...
    /// (.mp4/.m4v/.m4a/.m4s/.ts/.m2ts/.mts/.m3u8/.wav/.webm/.opus/.ogg). An http(s) URL with no media extension is a page URL
    ...
    public static bool IsDirectlyPlayable(string url)
    {
        ...
        return path.EndsWith(".mp4", StringComparison.OrdinalIgnoreCase)
            ...
            || path.EndsWith(".opus", StringComparison.OrdinalIgnoreCase)   // Ogg Opus
