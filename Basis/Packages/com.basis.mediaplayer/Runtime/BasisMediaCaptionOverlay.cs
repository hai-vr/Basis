...
//
// It is a pure presenter: the engine owns cue timing and selects the cue active at
// the current presentation position, so this only mirrors text and visibility.
