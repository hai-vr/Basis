...
[CustomEditor(typeof(BasisVideoPlayerDiagnostics))]
public class BasisVideoPlayerDiagnosticsInspector : Editor
{
    private const string UxmlPath = "Packages/com.basis.videoplayer/Editor/StyleSheets/VideoPlayerDiagnosticsSDK.uxml";
    private const string UssPath = "Packages/com.basis.videoplayer/Editor/StyleSheets/VideoPlayerSDK.uss";

    private BasisVideoPlayerDiagnostics _target;
    ...
    {
        _target = (BasisVideoPlayerDiagnostics)target;
        ...
        if (tree == null)
        {
            _root.Add(new HelpBox("VideoPlayerDiagnosticsSDK.uxml missing.", HelpBoxMessageType.Error));
            return _root;
        }
    ...
    private bool PlayModeOnly()
    {
        ...
        Debug.LogWarning("BasisVideoPlayerDiagnostics start/stop/flush only run in Play Mode.");
        return false;
    }

    private void RefreshStatus()
    {
        if (_target == null) _target = (BasisVideoPlayerDiagnostics)target;
        if (_target == null) return;
