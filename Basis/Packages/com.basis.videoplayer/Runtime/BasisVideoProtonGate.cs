...
// shared by every BasisVideoPlayer; if Media Foundation turns out to be absent
...
public static class BasisVideoProtonGate
{
    ...
    private static void Prompt()
    {
        ...
        var panel = BasisMenuDialoguePanel.CreateNew(
            ...
            "(and initializing it can be unstable here). Try to load the video player anyway?",
            "Load", "Skip",
            Resolve);
