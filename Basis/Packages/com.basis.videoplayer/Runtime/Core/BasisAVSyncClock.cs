...
//
// When an IBasisMediaClockSource is wired (BasisVideoPlayer hooks up a
// BasisVideoPlayerAudio on the same GameObject automatically), CurrentMediaTimeUs
...
public sealed class BasisAVSyncClock
{
    ...
    public void Reset()
    {
        ...
        // (BasisVideoPlayerAudio.ResetSyncAnchor).
    }
