...
// from whichever thread they read/decode on. Consumers (BasisVideoPlayer) marshal
// to the main thread for Unity API calls.
//
// Implementations: BasisSyntheticTestSource (CPU test pattern). Live OS-codec
// playback uses BasisNativeVideoSource (zero-copy GPU), which BasisVideoPlayer
